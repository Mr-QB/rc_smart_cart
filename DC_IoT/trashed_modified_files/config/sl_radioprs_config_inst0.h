...
#ifndef SL_RADIOPRS_CONFIG_INST0_H
#define SL_RADIOPRS_CONFIG_INST0_H

// <<< Use Configuration Wizard in Context Menu >>>
// <h> Radio PRS Configuration

// <o RADIOPRS_INST0_SOURCESEL> Radio PRS signal source
...
#define RADIOPRS_INST0_SOURCESEL PRS_MODEML_DOUT
...
// <<< sl:start pin_tool >>>
// <prs gpio=true > RADIOPRS_INST0
// $[PRS_RADIOPRS_INST0]
#ifndef RADIOPRS_INST0_CHANNEL                  
#define RADIOPRS_INST0_CHANNEL                   7
#endif

// [PRS_RADIOPRS_INST0]$
// <<< sl:end pin_tool >>>
#endif // SL_RADIOPRS_CONFIG_INST0_H
