...
#ifndef SL_RADIOPRS_CONFIG_INST_H
#define SL_RADIOPRS_CONFIG_INST_H

// <<< Use Configuration Wizard in Context Menu >>>
// <h> Radio PRS Configuration

// <o RADIOPRS_INST_SOURCESEL> Radio PRS signal source
...
#define RADIOPRS_INST_SOURCESEL PRS_MODEML_DOUT
...
// <<< sl:start pin_tool >>>
// <prs gpio=true > RADIOPRS_INST
// $[PRS_RADIOPRS_INST]
#ifndef RADIOPRS_INST_CHANNEL                   
#define RADIOPRS_INST_CHANNEL                    6
#endif

// [PRS_RADIOPRS_INST]$
// <<< sl:end pin_tool >>>
#endif // SL_RADIOPRS_CONFIG_INST_H
