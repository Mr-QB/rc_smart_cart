# Install script for directory: /home/cai/Dev/rc_smart_cart/orb-slam3-setup/pangolin/tools/VideoJson
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/cai/Dev/rc_smart_cart/orb-slam3-setup/pangolin/build/tools/VideoJson/VideoJsonPrint")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint"
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/cai/Dev/rc_smart_cart/orb-slam3-setup/pangolin/build/tools/VideoJson/VideoJsonTransform")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform"
